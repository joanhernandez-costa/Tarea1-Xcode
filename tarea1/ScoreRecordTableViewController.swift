//
//  ScoreRecordTableViewController.swift
//  tarea1
//
//  Created by user197292 on 10/27/23.
//
...
class ScoreRecordTableViewController: UITableViewController {
    ...
    var scoreRecord: [Game] = [Game(userName: "Jugador", score: 0.0, durationOfGame: "Tiempo", dateOfTheGame: "Fecha")]
    
    override func viewDidLoad() {
        super.viewDidLoad()
            
        scoreRecord.append(SaveLoad.readGame())
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let gameInPosition = scoreRecord[indexPath.item]
